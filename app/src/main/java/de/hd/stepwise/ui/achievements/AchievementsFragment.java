...
import de.hd.stepwise.databinding.FragmentAchievementsBinding;
...
public class AchievementsFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter = new AchievementAdapter(this::onSectionToggled);
    ...
    public void showAchievementDialog(Achievement achievement) {
        ...
        View view = LayoutInflater.from(requireContext()).inflate(R.layout.dialog_achievement_unlocked, null);

        ImageView icon = view.findViewById(R.id.icon);
        if (achievement.difficulty == AchievementDifficulty.BRONZE) {
            icon.setImageTintList(ContextCompat.getColorStateList(requireContext(), R.color.bronze));
        } else if (achievement.difficulty == AchievementDifficulty.SILVER) {
            icon.setImageTintList(ContextCompat.getColorStateList(requireContext(), R.color.silver));
        } else if (achievement.difficulty == AchievementDifficulty.GOLD) {
            icon.setImageTintList(ContextCompat.getColorStateList(requireContext(), R.color.gold));
        }
