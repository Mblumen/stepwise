...
import de.hd.stepwise.databinding.ListAchievementBinding;
...
public class AchievementAdapter extends BaseAdapter<ListItem, RecyclerView.ViewHolder> {
    ...
    private final Consumer<AchievementType> toggleCallback;

    public AchievementAdapter(Consumer<AchievementType> toggleCallback) {
    ...
    public static class AchievementViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Achievement achievement) {
            ...
            if (achievement.difficulty == AchievementDifficulty.STONE) {
